...
export default function SubscribersTable(params: { token: any }) {
    ...
    useEffect(() => {
        setIsLoading(true)
        axios.get(`${process.env.NEXT_PUBLIC_API_URL}/subscribers`, {
            headers: {
    ...
    */
    function handleDeleteData() {
        ...
        axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/subscribers/${deleteUser.id}`, {
            headers: {
                Authorization: `Bearer ${params.token}`
            }
        }).then((response: any) => {
